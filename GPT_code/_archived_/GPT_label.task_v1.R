...
d_train <- manually_tagged |> 
  ...
  ungroup() |>
  arrange(id_of_tweet)
# HC: I changed the sampling scheme so that you have a balanced sample from -1, 0, and 1
# Luc: Hello, perfect, thank you makes complete sense indeed
# Yes I can replicate the error you talked about. Let me look into it.
# Sounds amazing, thank you, so will I.
